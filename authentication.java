...
/*
 * This application authenticates and authorizes the employess of the zoo.
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (userInput.equalsIgnoreCase("y")) {
                ...
                int i; // attemptCounter that starts at 1
                ...
                if (i > 3) {
                    ...
                    System.out.println("Now taking back to the credential screen.");
                    System.out.println("");
                } 
                else {
